...
func TestPurgeDBReader(t *testing.T) {
	t.Run("should iterate with badger DB", testPurgeDBReader(WithKVType(KVTypeBadger)))

	t.Run("should iterate with pebble DB", testPurgeDBReader(WithKVType(KVTypePebble)))
}

func testPurgeDBReader(opts ...PurgeOption) func(*testing.T) {
	return func(t *testing.T) {
		...
		db, erk := openKV(kvStore, defaultPurgeOptions(opts))
